...
# 在pack()方法中，通过before参数依次设置各个组件的排列顺序
txt1.pack(side="left", padx=10, ipadx=6, fill="y", expand=True)
txt2.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt1)
txt3.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt2)
txt4.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt3)
txt5.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt4)
txt6.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt5)
txt7.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt6)
txt8.pack(side="left", padx=10, ipadx=6, fill="y", expand=True, before=txt7)
win.mainloop()
